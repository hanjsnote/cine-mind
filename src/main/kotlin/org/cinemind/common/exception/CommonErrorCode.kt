...
enum class CommonErrorCode(
    ...
    // 400 RAG 도메인 에러
    RAG_DATA_MISSING(HttpStatus.BAD_REQUEST, "RAG 인덱싱에 필수적인 데이터 필드가 누락되었습니다."),
    ...
    // 404 RAG 도메인 에러
    MOVIE_NOT_FOUND_FOR_RAG(HttpStatus.NOT_FOUND, "임베딩 변환 중 원본 Movie 엔티티를 찾을 수 없습니다."),

    // 409 Conflict
    DUPLICATE_EMAIL(HttpStatus.CONFLICT, "이미 존재하는 이메일입니다."),

    // 500 Internal Server Error (예상치 못한 비즈니스 오류)
    DATABASE_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "서버 처리 중 오류가 발생했습니다.");
